        ...
        if (this.state.isCheckedCreditBuy && this.state.isCheckedCityWallet) {  // both true
            if(+credit_balance < +actual_order_amount){
                ...
                this.setState({
                    ...
                    isCheckedCreditBuy: false,
                    alertTitle: "Oops!",
                    alertMsg: "Your Credit Balance Is Low, You Can Pay Through City Wallet."
                    // isCheckedCityWallet: false
                })
                // return
            }
                ...
                if (+credit_balance == 0) {
                    ...
                    this.setState({
                        showEmptyCartModal: true,
                        alertTitle: "Oops!",
                        alertMsg: "Your credit balance is low.\nPlease use other features.",
                        isCheckedCreditBuy: false,
                        isCheckedCityWallet: false
                    })
                } else {
                ...
                if (+city_wallet_balance == 0 && +credit_balance == 0) {
                    ...
                    this.setState({
                        showEmptyCartModal: true,
                        alertTitle: "Oops!",
                        alertMsg: "Your credit balance and wallet is low.\nPlease use other features.",
                        isCheckedCreditBuy: false,
                        isCheckedCityWallet: false
                    })
                    payment_obj = {
            ...
            if ( +city_wallet_balance > +actual_order_amount) {
                ...
                if (+city_wallet_balance == 0) {
                    ...
                    this.setState({
                        showEmptyCartModal: true,
                        alertTitle: "Oops!",
                        alertMsg: "Your wallet balance is low.\nPlease use other features.",
                        isCheckedCreditBuy: false,
                        isCheckedCityWallet: false
                    })
                    payment_obj = {
